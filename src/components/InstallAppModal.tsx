...
import { X, Download, Smartphone, Check, Sparkles, Share, PlusSquare, Monitor } from 'lucide-react';
        ...
        {isInstalled ? (
          ...
          <div className="space-y-4">
            ...
            <button
              ...
              onClick={async () => {
                if (isInstallable) {
                  ...
                  // iOS can't prompt programmatically, user guided below
                } else {
            ...
            >
              ...
              <span>{isInstallable ? 'Install to Home Screen' : 'Install App Now'}</span>
            </button>
            ...
            {isIOS ? (
              <div className="text-left bg-[#F5EFE6] dark:bg-[#071911] p-4 rounded-2xl border border-[#1B4332]/15 dark:border-[#D4AF37]/30 text-xs text-stone-700 dark:text-stone-300 space-y-2">
                ...
                <ol className="list-decimal list-inside space-y-1.5 text-[11px] leading-relaxed text-stone-600 dark:text-stone-300">
                  <li>
                    Tap the <Share className="w-3.5 h-3.5 inline mx-1 text-sky-600" /> <strong>Share</strong> button in Safari
                  </li>
                  <li>
                    Scroll down and select <PlusSquare className="w-3.5 h-3.5 inline mx-1 text-stone-800 dark:text-stone-200" /> <strong>Add to Home Screen</strong>
                  </li>
                  <li>
                    Tap <strong>Add</strong> at top right to place the Noor Ayat app icon on your home screen
                  </li>
                </ol>
              </div>
            ) : (
              <div className="text-left bg-[#F5EFE6] dark:bg-[#071911] p-4 rounded-2xl border border-[#1B4332]/15 dark:border-[#D4AF37]/30 text-xs text-stone-700 dark:text-stone-300 space-y-2">
                <p className="font-bold text-[#1B4332] dark:text-[#D4AF37] flex items-center gap-1.5">
                  <Monitor className="w-4 h-4" /> Install on Android / Desktop:
                </p>
                <ol className="list-decimal list-inside space-y-1.5 text-[11px] leading-relaxed text-stone-600 dark:text-stone-300">
                  <li>
                    Open your browser menu (three dots <strong>⋮</strong>) in the top-right
                  </li>
                  <li>
                    Tap <strong>"Install App"</strong> or <strong>"Add to Home Screen"</strong>
                  </li>
                  <li>
                    Confirm to launch directly from your home screen icon
                  </li>
                </ol>
              </div>
            )}
